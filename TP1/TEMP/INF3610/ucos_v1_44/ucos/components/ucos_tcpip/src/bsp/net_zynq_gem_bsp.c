...
static  void  NetDev_ISR_Handler              (void*p_arg, CPU_INT32U cpu_id);
...
const  NET_DEV_BSP_ETHER     NetDev_BSP_GEM_0 = {                               /* Board-/device-specific BSP fnct ptrs : */
                             ...
                             NET_ERR  *p_err)
{
   ...
   reg_val = *((CPU_REG32 *)(0xE000B004));

   if (reg_val & DEF_BIT_10) {
       /* 1000Mbps. */
       *((CPU_REG32 *)(0xF8000008)) = 0xDF0Du;
       CPU_MB();
       *((CPU_REG32 *)(0xF8000138)) = 0x00000001;
       *((CPU_REG32 *)(0xF8000140))  = (1 << 20) | (8 << 8) | (0 << 4) | (1 << 0);
       CPU_MB();
       *((CPU_REG32 *)(0xF8000004))   = 0x767Bu;
   } else if (reg_val & DEF_BIT_00) {
       /* 100Mbps. */
       *((CPU_REG32 *)(0xF8000008)) = 0xDF0Du;
       CPU_MB();
       *((CPU_REG32 *)(0xF8000138)) = 0x00000001;
       *((CPU_REG32 *)(0xF8000140))  = (1 << 20) | (40 << 8) | (0 << 4) | (1 << 0);
       CPU_MB();
       *((CPU_REG32 *)(0xF8000004))   = 0x767Bu;
   } else {
       /* 10 Mbps. */
       *((CPU_REG32 *)(0xF8000008)) = 0xDF0Du;
       CPU_MB();
       *((CPU_REG32 *)(0xF8000138)) = 0x00000001;
       *((CPU_REG32 *)(0xF8000140))  = (10 << 20) | (40 << 8) | (0 << 4) | (1 << 0);
       CPU_MB();
       *((CPU_REG32 *)(0xF8000004))   = 0x767Bu;
   }
