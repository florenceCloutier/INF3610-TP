...
#define  USBD_LPCXX_DEV_ADDR_USBADDRA               DEF_BIT_24  /* Device Address Advance                               */
                                                                /* Device Address Mask                                  */
#define  USBD_LPCXX_DEV_ADDR_USBADDR_MASK           DEF_BIT_FIELD_32(7u, 25u)

#define  USBD_LPCXX_PORTSC1_HSP                     DEF_BIT_09  /* High-Speed port                                      */
#define  USBD_LPCXX_PORTSC1_FPR                     DEF_BIT_06  /* Force port resume.                                   */
#define  USBD_LPCXX_PORTSC1_PFSC                    DEF_BIT_24  /* Full-Speed port                                      */

                                                                /* ------ USB INTERRUPT AND STATUS REGISTER BITS ------ */
#define  USBD_LPCXX_USBSTS_NAKI                     DEF_BIT_16  /* NAK Interrupt Bit.                                   */
#define  USBD_LPCXX_USBSTS_AS                       DEF_BIT_15  /* Asynchronous Schedule Status.                        */
#define  USBD_LPCXX_USBSTS_PS                       DEF_BIT_14  /* Periodic Schedule Status.                            */
#define  USBD_LPCXX_USBSTS_RCL                      DEF_BIT_13  /* Reclamation.                                         */
#define  USBD_LPCXX_USBSTS_HCH                      DEF_BIT_12  /* HCHaIted.                                            */
#define  USBD_LPCXX_USBSTS_ULPI                     DEF_BIT_10  /* ULPI Interrupt.                                      */
#define  USBD_LPCXX_USBSTS_SLI                      DEF_BIT_08  /* DCSuspend.                                           */
#define  USBD_LPCXX_USBSTS_SRI                      DEF_BIT_07  /* SOF Received.                                        */
#define  USBD_LPCXX_USBSTS_URI                      DEF_BIT_06  /* USB Reset Received.                                  */
#define  USBD_LPCXX_USBSTS_AAI                      DEF_BIT_05  /* Interrupt on Async Advance.                          */
#define  USBD_LPCXX_USBSTS_SEI                      DEF_BIT_04  /* System Error.                                        */
#define  USBD_LPCXX_USBSTS_FRI                      DEF_BIT_03  /* Frame List Rollover.                                 */
#define  USBD_LPCXX_USBSTS_PCI                      DEF_BIT_02  /* Port Change Detect.                                  */
#define  USBD_LPCXX_USBSTS_UEI                      DEF_BIT_01  /* USB Error Interrupt.                                 */
#define  USBD_LPCXX_USBSTS_UI                       DEF_BIT_00  /* USB Interrupt.                                       */

                                                                /* ------ USB INTERRUPT REGISTER (USBINTR) BITS ------- */
#define  USBD_LPCXX_USBSTS_NAKE                     DEF_BIT_16  /* NAK Interrupt enable                                 */
#define  USBD_LPCXX_USBSTS_ULPIE                    DEF_BIT_10  /* ULPI enable                                          */
#define  USBD_LPCXX_USBSTS_SLE                      DEF_BIT_08  /* Sleep enable                                         */
#define  USBD_LPCXX_USBSTS_SRE                      DEF_BIT_07  /* SOF received enable                                  */
#define  USBD_LPCXX_USBSTS_URE                      DEF_BIT_06  /* USB reset enable                                     */
#define  USBD_LPCXX_USBSTS_AAE                      DEF_BIT_05  /* Interrupt on Async Advance enable                    */
#define  USBD_LPCXX_USBSTS_SEE                      DEF_BIT_04  /* System Error enable                                  */
#define  USBD_LPCXX_USBSTS_FRE                      DEF_BIT_03  /* Frame List Rollover enable                           */
#define  USBD_LPCXX_USBSTS_PCE                      DEF_BIT_02  /* Port Change Detect enable                            */
#define  USBD_LPCXX_USBSTS_UEE                      DEF_BIT_01  /* USB Error Interrupt enable                           */
#define  USBD_LPCXX_USBSTS_UE                       DEF_BIT_00  /* USB Interrupt enable                                 */

                                                                /* ------------ USB INTERRUPT ENABLE BITS ------------- */
#define  USBD_LPCXX_USB_INT_NAK                     DEF_BIT_16  /* NAK Interrupt enable                                 */
#define  USBD_LPCXX_USB_INT_ULP                     DEF_BIT_10  /* ULPI enable                                          */
#define  USBD_LPCXX_USB_INT_SL                      DEF_BIT_08  /* Sleep enable                                         */
#define  USBD_LPCXX_USB_INT_SR                      DEF_BIT_07  /* SOF received enable                                  */
#define  USBD_LPCXX_USB_INT_UR                      DEF_BIT_06  /* USB reset enable                                     */
#define  USBD_LPCXX_USB_INT_AA                      DEF_BIT_05  /* Interrupt on Async Advance enable                    */
#define  USBD_LPCXX_USB_INT_SE                      DEF_BIT_04  /* System Error enable                                  */
#define  USBD_LPCXX_USB_INT_FR                      DEF_BIT_03  /* Frame List Rollover enable                           */
#define  USBD_LPCXX_USB_INT_PC                      DEF_BIT_02  /* Port Change Detect enable                            */
#define  USBD_LPCXX_USB_INT_UE                      DEF_BIT_01  /* USB Error Interrupt enable                           */
#define  USBD_LPCXX_USB_INT_U                       DEF_BIT_00  /* USB Interrupt enable                                 */

#define  USBD_LPCXX_USB_INT_BUS                    (USBD_LPCXX_USB_INT_PC | \
                                                    USBD_LPCXX_USB_INT_UR | \
                                                    USBD_LPCXX_USB_INT_SL)


                                                                /* --------- USB COMMAND REGISTER BIT DEFINES --------- */
                                                                /* Interrupt Threshold Control                          */
#define  USBD_LPCXX_USBCMD_ITC_MASK                 DEF_BIT_FIELD_32(8u, 16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_1        DEF_BIT_MASK(0x01u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_2        DEF_BIT_MASK(0x02u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_3        DEF_BIT_MASK(0x04u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_8        DEF_BIT_MASK(0x08u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_16       DEF_BIT_MASK(0x10u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_32       DEF_BIT_MASK(0x20u,  16u)
#define  USBD_LPCXX_USBCMD_ITC_MICRO_FRAME_40       DEF_BIT_MASK(0x40u,  16u)

                                                                /* Frame List size                                      */
#define  USBD_LPCXX_USBCMD_FS_MASK                  DEF_BIT_FIELD(2u, 14u)
#define  USBD_LPCXX_USBCMD_ATDTW                    DEF_BIT_14  /* Add dTD TripWire                                     */

#define  USBD_LPCXX_USBCMD_SUTW                     DEF_BIT_13  /* Setup Tripwire                                       */
#define  USBD_LPCXX_USBCMD_ASPE                     DEF_BIT_11  /* Asynchronous schedule park mode enable               */
                                                                /* Asynchronous schedule park mode count                */
#define  USBD_LPCXX_USBCMD_ASP_MASK                 DEF_BIT_FIELD(2u, 8u)
#define  USBD_LPCXX_USBCMD_LR                       DEF_BIT_07  /* Light Host/Device controller reset                   */
#define  USBD_LPCXX_USBCMD_IAA                      DEF_BIT_06  /* Interrupt on Async Advance Doorbell                  */
#define  USBD_LPCXX_USBCMD_ASE                      DEF_BIT_05  /* Asynchronous schedule enable                         */
#define  USBD_LPCXX_USBCMD_PSE                      DEF_BIT_04  /* Periodic schedule enable                             */

                                                                /* Frame List Size mask                                 */
#define  USBD_LPCXX_USBCMD_FS_SIZE_MASK             DEF_BIT_FIELD(3u, 2u)
#define  USBD_LPCXX_USBCMD_RST                      DEF_BIT_01  /* Controller Reset                                     */
#define  USBD_LPCXX_USBCMD_RUN                      DEF_BIT_00  /* Run Stop                                             */

                                                                /* ------ USB DEVICE ADDRESS REGISTER BIT DEFINES ----- */
                                                                /* Device Address mask                                  */
#define  USBD_LPCXX_DEV_ADDR_USBADR_MASK            DEF_BIT_FIELD(6u, 25u)
#define  USBD_LPCXX_DEV_ADDR_USBADRA                DEF_BIT_24  /* Device Address Advance.                              */

                                                                /* ---- ENDPOINT LIST ADDRESS REGISTER BIT DEFINES ---- */
#define  USBD_LPCXX_EP_LIST_ADDR_MASK               DEF_BIT_FIELD(21u, 11u)

                                                                /* ----------- USB MODE REGISTER BIT DEFINES ---------- */
#define  USBD_LPCXX_USBMODE_SDIS                    DEF_BIT_04  /* Stream Disable Mode                                  */
#define  USBD_LPCXX_USBMODE_SLOM                    DEF_BIT_03  /* Setup lockout mode                                   */
#define  USBD_LPCXX_USBMODE_ES                      DEF_BIT_02  /* Endianness selection                                 */
                                                                /* Controller Mode mask                                 */

#define  USBD_LPCXX_USBMODE_CM_MASK                 DEF_BIT_FIELD(2u, 0u)
                                                                /* Idle   mode                                          */
#define  USBD_LPCXX_USBMODE_CM_IDLE                 DEF_BIT_NONE
#define  USBD_LPCXX_USBMODE_CM_DEV                  DEF_BIT_01  /* Device mode                                          */
                                                                /* Host   mode                                          */
#define  USBD_LPCXX_USBMODE_CM_HOST                (DEF_BIT_01 | DEF_BIT_02)

                                                                /* ------- ENDPOINT CONTROL REGISTER BIT DEFINES ------ */
#define  USBD_LPCXX_ENDPTCTRL_TX_CFG_MASK           DEF_BIT_FIELD_32(8u, 16u)
#define  USBD_LPCXX_ENDPTCTRL_TX_EN                 DEF_BIT_23  /* Tx endpoint enable                                   */
#define  USBD_LPCXX_ENDPTCTRL_TX_TOGGLE_RST         DEF_BIT_22  /* Data Toggle reset                                    */
#define  USBD_LPCXX_ENDPTCTRL_TX_TOGGLE_DIS         DEF_BIT_21  /* Data Toggle inhibit                                  */
                                                                /* Tx endpoint type mask                                */
#define  USBD_LPCXX_ENDPTCTRL_TX_TYPE_MASK          DEF_BIT_FIELD_32(2u, 18u)
                                                                /* Tx endpoint type control                             */
#define  USBD_LPCXX_ENDPTCTRL_TX_TYPE_CTRL          DEF_BIT_NONE
#define  USBD_LPCXX_ENDPTCTRL_TX_TYPE_ISOC          DEF_BIT_18  /* Tx endpoint type isochronous                         */
#define  USBD_LPCXX_ENDPTCTRL_TX_TYPE_BULK          DEF_BIT_19  /* Tx endpoint type bulk                                */
                                                                /* Tx endpoint type interrupt                           */
#define  USBD_LPCXX_ENDPTCTRL_TX_TYPE_INT          (DEF_BIT_18 | DEF_BIT_19)
#define  USBD_LPCXX_ENDPTCTRL_TX_DATA_SRC           DEF_BIT_17  /* Tx endpoint data source                              */
#define  USBD_LPCXX_ENDPTCTRL_TX_STALL              DEF_BIT_16  /* Tx endpoint stall                                    */

#define  USBD_LPCXX_ENDPTCTRL_RX_CFG_MASK           DEF_BIT_FIELD_32(8u, 0u)
#define  USBD_LPCXX_ENDPTCTRL_RX_EN                 DEF_BIT_07  /* Rx endpoint enable                                   */
#define  USBD_LPCXX_ENDPTCTRL_RX_TOGGLE_RST         DEF_BIT_06  /* Rx Data Toggle reset                                 */
#define  USBD_LPCXX_ENDPTCTRL_RX_TOGGLE_DIS         DEF_BIT_05  /* Rx Data Toggle inhibit                               */
                                                                /* Rx endpoint type mask                                */
#define  USBD_LPCXX_ENDPTCTRL_RX_TYPE_MASK          DEF_BIT_FIELD_32(2u, 2u)
                                                                /* Rx endpoint type control                             */
#define  USBD_LPCXX_ENDPTCTRL_RX_TYPE_CTRL          DEF_BIT_NONE
#define  USBD_LPCXX_ENDPTCTRL_RX_TYPE_ISOC          DEF_BIT_02  /* Rx endpoint type isochronous                         */
#define  USBD_LPCXX_ENDPTCTRL_RX_TYPE_BULK          DEF_BIT_03  /* Rx endpoint type bulk                                */
                                                                /* Rx endpoint type interrupt                           */
#define  USBD_LPCXX_ENDPTCTRL_RX_TYPE_INT          (DEF_BIT_02 | DEF_BIT_03)
#define  USBD_LPCXX_ENDPTCTRL_RX_DATA_SRC           DEF_BIT_01  /* Rx endpoint data source                              */
#define  USBD_LPCXX_ENDPTCTRL_RX_STALL              DEF_BIT_00  /* Rx endpoint stall                                    */

#define  USBD_LPCXX_ENDPTCOMPLETE_TX_MASK           DEF_BIT_FIELD_32(6u, 16u)
#define  USBD_LPCXX_ENDPTCOMPLETE_RX_MASK           DEF_BIT_FIELD_32(6u,  0u)

#define  USBD_LPCXX_ENDPTxxxx_TX_MASK               DEF_BIT_FIELD_32(6u, 16u)
#define  USBD_LPCXX_ENDPTxxxx_RX_MASK               DEF_BIT_FIELD_32(6u,  0u)

                                                                /* -- ENDPOINT QUEUE HEAD EP CAPABILITIES BIT DEFINES - */
                                                                /* Number of packets executed per transaction.          */
#define  USBD_LPCXX_dQH_EP_CAP_MULT_MASK            DEF_BIT_FIELD_32(2u, 30u)
#define  USBD_LPCXX_dQH_EP_CAP_MULT_N               DEF_BIT_MASK(0u, 30u)
#define  USBD_LPCXX_dQH_EP_CAP_MULT_1               DEF_BIT_MASK(1u, 30u)
#define  USBD_LPCXX_dQH_EP_CAP_MULT_2               DEF_BIT_MASK(2u, 30u)
#define  USBD_LPCXX_dQH_EP_CAP_MULT_3               DEF_BIT_MASK(3u, 30u)

#define  USBD_LPCXX_dQH_EP_CAP_ZLTS                 DEF_BIT_29  /* Zero Length Termination Select                       */
                                                                /* EP maximum length mask                               */
#define  USBD_LPCXX_dQH_EP_CAP_MAX_LEN_MASK         DEF_BIT_FIELD_32(11u, 16u)
#define  USBD_LPCXX_dQH_EP_CAP_IOS                  DEF_BIT_15  /* Interrupt on setup                                   */

                                                                /* ------------ dTD_NEXT FIELD  BIT DEFINES ----------- */
                                                                /* Next transfer element pointer mask                   */
#define  USBD_LPCXX_dTD_dTD_NEXT_MASK               DEF_BIT_FIELD_32(27u, 5u)
#define  USBD_LPCXX_dTD_dTD_NEXT_TERMINATE          DEF_BIT_00  /* End of transfer list indicator                       */

                                                                /* -------------- TOKEN FILED BIT DEFINES ------------- */
#define  USBD_LPCXX_dTD_TOKEN_TOTAL_BYTES_MASK      DEF_BIT_FIELD_32(15u, 16u)
#define  USBD_LPCXX_dTD_TOKEN_IOC                   DEF_BIT_15  /* Interrupt on complete                                */
                                                                /* Multiplier override mask                             */
#define  USBD_LPCXX_dTD_TOKEN_MUL_OVER_MASK         DEF_BIT_FIELD_32(2u, 10u)

#define  USBD_LPCXX_dTD_TOKEN_TOTAL_BYTE_MAX        0x00004000u /* Maximum number of bytes                              */

#define  USBD_LPCXX_dTD_TOKEN_PAGE_SIZE             0x00001000u /* Page size 4K                                         */
                                                                /* Status mask                                          */
#define  USBD_LPCXX_dTD_TOKEN_STATUS_MASK           DEF_BIT_FIELD_32(8u, 0u)
#define  USBD_LPCXX_dTD_TOKEN_STATUS_ACTIVE         DEF_BIT_07
#define  USBD_LPCXX_dTD_TOKEN_STATUS_HALTED         DEF_BIT_06
#define  USBD_LPCXX_dTD_TOKEN_STATUS_DATA_ERR       DEF_BIT_05
#define  USBD_LPCXX_dTD_TOKEN_STATUS_TRAN_ERR       DEF_BIT_03
...
#define  USBD_LPCXX_dTD_BUF_PTR_MASK                DEF_BIT_FIELD(20u, 12u)


                                                                /* ----------- IP_INFO REGISTER BIT DEFINES ----------- */
#define  USBD_LPCXX_IP_INFO_IP_MASK                 DEF_BIT_FIELD_32(16u, 16u)
#define  USBD_LPCXX_IP_INFO_MAJOR_MASK              DEF_BIT_FIELD_32(4u,  12u)
#define  USBD_LPCXX_IP_INFO_MINOR_MASK              DEF_BIT_FIELD_32(4u,   8u)
...
#define  USBD_LPCXX_REG_TO                           0x0000FFFFu
#define  USBD_LPCXX_MAX_RETRIES                             100u
#define  USBD_LPCXX_dTD_LST_INSERT_NBR_TRIES_MAX            100u
#define  USBD_LPCXX_dTD_NBR_PAGES                             5u

#define  USBD_LPCXX_EP_NBR_MAX                               12u/* See Note #1.                                         */

#define  USBD_LPCXX_dTD_EXT_ATTRIB_IS_COMPLETED     DEF_BIT_00

#define  USBD_LPCXX_ALIGN_OCTECTS_dQH               ( 2u * (1024u))
#define  USBD_LPCXX_ALIGN_OCTECTS_dTD               (64u * (   1u))
#define  USBD_LPCXX_ALIGN_OCTECTS_BUF               ( 1u * (   1u))

#define  USBD_LPCXX_MAX_NBR_EP_OPEN                 DEF_MIN(USBD_CFG_MAX_NBR_EP_OPEN, USBD_LPCXX_EP_NBR_MAX)
#define  USBD_LPCXX_dTD_NBR                        (USBD_CFG_MAX_NBR_URB_EXTRA + \
                                                    USBD_LPCXX_MAX_NBR_EP_OPEN )
...
#define  USBD_LPCXX_ENDPTxxx_GET_TX_BITS(ep_log_nbr)            (DEF_BIT32(ep_log_nbr) << 16u)
#define  USBD_LPCXX_ENDPTxxx_GET_RX_BITS(ep_log_nbr)             DEF_BIT32(ep_log_nbr)

#define  USBD_LPCXX_ENDPTxxx_GET_TX_NBR(ep_reg)                 (((ep_reg) & USBD_LPCXX_ENDPTxxxx_TX_MASK) >> 16u)
#define  USBD_LPCXX_ENDPTxxx_GET_RX_NBR(ep_reg)                  ((ep_reg) & USBD_LPCXX_ENDPTxxxx_RX_MASK)

#define  USBD_LPCXX_EP_PHY_NBR_IS_OUT(ep_phy_nbr)                DEF_BIT_IS_CLR((ep_phy_nbr), DEF_BIT_00)
...
typedef  struct usbd_lpcxx_usb_reg {                            /* See Note #1.                                         */
    ...
    CPU_REG32  ENDPTCTRLx[USBD_LPCXX_EP_NBR_MAX];               /*           Endpoint control registers                 */
}  USBD_LPCXX_REG;

                                                                /* --- ENDPOINT TRANSFER DESCRIPTOR (dTD) DATA TYPE --- */
typedef  struct  usbd_lpcxx_dtd {
...
typedef  struct  usbd_lpcxx_dtd_ext {
    CPU_REG32   dTD_NextPtr;                                    /* Next link pointer.                                   */
    CPU_REG32   Token;                                          /* dTD token.                                           */
    CPU_REG32   BufPtrs[5u];                                    /* Buffer pointer (Page n, n = [0..4]).                 */
...
static  void         USBD_DrvInitLPCXX  (USBD_DRV     *p_drv,
                                         USBD_ERR     *p_err);

static  void         USBD_DrvInitZynq   (USBD_DRV     *p_drv,
                                         USBD_ERR     *p_err);
...
static  void         USBD_LPCXX_Init         (USBD_DRV    *p_drv,
                                              USBD_ERR    *p_err);

                                                                /* ------------- dTD's LINK LIST FUNCTIONS ------------ */
static  void         USBD_LPCXX_dTD_LstInsert(USBD_DRV    *p_drv,
                                              CPU_INT08U   ep_phy_nbr,
                                              CPU_INT08U  *p_data,
                                              CPU_INT16U   len,
                                              USBD_ERR    *p_err);

static  CPU_BOOLEAN  USBD_LPCXX_dTD_LstRemove(USBD_DRV    *p_drv,
                                              CPU_INT08U   ep_phy_nbr);

static  CPU_BOOLEAN  USBD_LPCXX_dTD_LstEmpty (USBD_DRV    *p_drv,
                                              CPU_INT08U   ep_phy_nbr);

static  void         USBD_LPCXX_SetupProcess (USBD_DRV    *p_drv,
                                              CPU_INT08U   ep_log_nbr);

static  void         USBD_LPCXX_SoftRst      (USBD_DRV    *p_drv);
...
USBD_DRV_API  USBD_DrvAPI_LPCXX_USBX = { USBD_DrvInitLPCXX,
                                         USBD_DrvStart,
                                         USBD_DrvStop,
                                         USBD_DrvAddrSet,
                                         USBD_DrvAddrEn,
...
USBD_DRV_API  USBD_DrvAPI_Zynq = { USBD_DrvInitZynq,
                                   USBD_DrvStart,
                                   USBD_DrvStop,
                                   USBD_DrvAddrSet,
                                   USBD_DrvAddrEn,
...
*                                         USBD_DrvInitLPCXX()
*
* Description : Initialize the device for the NXP LPC313x/LPC18xx/LPC43xx.
*
                                 ...
                                 USBD_ERR  *p_err)
{
    ...
    USBD_LPCXX_Init(p_drv, p_err);

    if (*p_err == USBD_ERR_NONE) {
        p_drv_data         = (USBD_DRV_DATA *)p_drv->DataPtr;
        p_drv_data->Ctrlr  =  USBD_NXP_USBX_CTRLR_LPCXX;        /* Indicates that driver used on NXP LPCxx.             */
    }
}
...
*                                          USBD_DrvInitZynq()
*
* Description : Initialize the device for the Xilinx Zynq-7000.
*
* Argument(s) : p_drv       Pointer to device driver structure.
*
*               p_err       Pointer to variable that will receive the return error code from this function :
                                ...
                                USBD_ERR  *p_err)
{
    ...
    if (*p_err == USBD_ERR_NONE) {
        p_drv_data         = (USBD_DRV_DATA *)p_drv->DataPtr;
        p_drv_data->Ctrlr  =  USBD_XILINX_USBX_CTRLR_ZYNQ;      /* Indicates that driver used on Xilinx Zynq.           */
    }
}
                             ...
                             USBD_ERR  *p_err)
{
    ...
    USBD_DRV_DATA     *p_drv_data;
    USBD_LPCXX_REG    *p_reg;
    CPU_INT16U         reg_to;


    p_bsp_api  =  p_drv->BSP_API_Ptr;                           /* Get driver BSP API reference.                        */
    p_drv_data = (USBD_DRV_DATA  *)(p_drv->DataPtr);
    p_reg      = (USBD_LPCXX_REG *)(p_drv->CfgPtr->BaseAddr);

    p_reg->USBCMD = USBD_LPCXX_USBCMD_RST;                      /* Reset controller (see Note #2)                       */

    reg_to = USBD_LPCXX_REG_TO;
    while (reg_to > 0) {
        reg_to--;
    }

    if (p_drv_data->Ctrlr == USBD_NXP_USBX_CTRLR_LPCXX) {
        p_drv_data->hw_rev  = (CPU_INT08U)(CPU_INT32U)(((p_reg->IP_INFO & USBD_LPCXX_IP_INFO_MAJOR_MASK) >> 12u) * 10u);
        p_drv_data->hw_rev += (CPU_INT08U)(CPU_INT32U)(((p_reg->IP_INFO & USBD_LPCXX_IP_INFO_MINOR_MASK) >>  8u));
    }

    p_reg->USBMODE = USBD_LPCXX_USBMODE_CM_DEV;                 /* Set device mode                                      */

    p_reg->USBINTR     = DEF_BIT_NONE;                          /* Disable all interrupts                               */
    p_reg->EP_LST_ADDR = (CPU_INT32U)p_drv_data->dQH_Tbl;

    DEF_BIT_SET(p_reg->USBMODE, USBD_LPCXX_USBMODE_SLOM);       /* Disable setup lockout                                */
    DEF_BIT_CLR(p_reg->USBMODE, USBD_LPCXX_USBMODE_SDIS);       /* Enable double priming on both Rx and Tx.             */

    USBD_LPCXX_SoftRst(p_drv);                                  /* Perform software reset                               */

    DEF_BIT_CLR(p_reg->USBCMD, USBD_LPCXX_USBCMD_ITC_MASK);     /* Dev ctrlr fires USB intr immediately.                */

    p_reg->USBINTR = USBD_LPCXX_USB_INT_UR                      /* Enable the Reset and Suspend interrupt               */
                   | USBD_LPCXX_USB_INT_SL;

    if (p_drv->CfgPtr->Spd == USBD_DEV_SPD_FULL) {
        DEF_BIT_SET(p_reg->PORTSC1, USBD_LPCXX_PORTSC1_PFSC);   /* Force FS.                                            */
    }

    DEF_BIT_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_RUN);          /* Set the RUN bit                                      */
...
static  void  USBD_DrvStop (USBD_DRV  *p_drv)
{
    ...
    DEF_BIT_CLR(p_reg->USBCMD, USBD_LPCXX_USBCMD_RUN);          /* Clear the RUN bit                                    */
}
                                      ...
                                      CPU_INT08U   dev_addr)
{
    ...
    p_reg           = (USBD_LPCXX_REG *)(p_drv->CfgPtr->BaseAddr);
    p_reg->DEV_ADDR = ((dev_addr << 25u) & USBD_LPCXX_DEV_ADDR_USBADDR_MASK) |
                                           USBD_LPCXX_DEV_ADDR_USBADDRA;
                               ...
                               USBD_ERR    *p_err)
{
    ...
    reg_val = USBD_LPCXX_ENDPTCTRL_TX_EN |                      /* Enable EP Tx (i.e. IN direction).                    */
              USBD_LPCXX_ENDPTCTRL_RX_EN;                       /* Enable EP Rx (i.e. OUT direction).                   */

    switch (ep_type) {                                          /* Set the EP Tx and Rx type.                           */
        case USBD_EP_TYPE_CTRL:
             DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_TX_TYPE_CTRL |
                                  USBD_LPCXX_ENDPTCTRL_RX_TYPE_CTRL);
             break;


        case USBD_EP_TYPE_ISOC:
             DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_TX_TYPE_ISOC |
                                  USBD_LPCXX_ENDPTCTRL_RX_TYPE_ISOC);
             break;


        case USBD_EP_TYPE_INTR:
             DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_TX_TYPE_INT |
                                  USBD_LPCXX_ENDPTCTRL_RX_TYPE_INT);
             break;


        case USBD_EP_TYPE_BULK:
             DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_TX_TYPE_BULK |
                                  USBD_LPCXX_ENDPTCTRL_RX_TYPE_BULK);
             break;
    ...
    if (ep_type != USBD_EP_TYPE_CTRL) {                         /* Reset Tx & Rx data toggle.                           */
        DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_TX_TOGGLE_RST);
        DEF_BIT_SET(reg_val, USBD_LPCXX_ENDPTCTRL_RX_TOGGLE_RST);
    }

    CPU_CRITICAL_ENTER();
    if (ep_dir_in == DEF_FALSE) {                               /* OUT Endpoints                                        */
                                                                /* Reset reg upper half to keep only Rx related bits.   */
        reg_val &= USBD_LPCXX_ENDPTCTRL_RX_CFG_MASK;
        DEF_BIT_CLR(p_reg->ENDPTCTRLx[ep_log_nbr], USBD_LPCXX_ENDPTCTRL_RX_CFG_MASK);
    } else {                                                    /* IN Endpoints                                         */
                                                                /* Reset reg lower half to keep only Tx related bits.   */
        reg_val &= USBD_LPCXX_ENDPTCTRL_TX_CFG_MASK;
        DEF_BIT_CLR(p_reg->ENDPTCTRLx[ep_log_nbr], USBD_LPCXX_ENDPTCTRL_TX_CFG_MASK);
    }
    ...
    reg_val = ((max_pkt_size << 16u) & USBD_LPCXX_dQH_EP_CAP_MAX_LEN_MASK);

    if ((ep_type   == USBD_EP_TYPE_CTRL) &&
        (ep_dir_in == DEF_FALSE)) {
        DEF_BIT_SET(reg_val              , USBD_LPCXX_dQH_EP_CAP_IOS);
    ...
    if ((ep_type == USBD_EP_TYPE_CTRL) ||
        ...
        DEF_BIT_SET(reg_val, USBD_LPCXX_dQH_EP_CAP_ZLTS);
    }

    if (ep_type == USBD_EP_TYPE_ISOC) {
        if (transaction_frame == 1u) {
            DEF_BIT_SET(reg_val, USBD_LPCXX_dQH_EP_CAP_MULT_1);
        } else if (transaction_frame == 2u) {                   /* #### This case must be tested.                       */
            DEF_BIT_SET(reg_val, USBD_LPCXX_dQH_EP_CAP_MULT_2);
        } else if (transaction_frame == 3u) {                   /* #### This case must be tested.                       */
            DEF_BIT_SET(reg_val, USBD_LPCXX_dQH_EP_CAP_MULT_3);
        }
    }

//    BSP_DCache_InvalidateRange(p_dqh, sizeof(USBD_LPCXX_dQH));  /* Invalidate (clear) the cached RAM block, so that the */
    CPU_DCACHE_RANGE_INV(p_dqh, sizeof(USBD_LPCXX_dQH));        /* Invalidate (clear) the cached RAM block, so that the */
                                                                /* next CPU read will be from RAM again.                */
    p_dqh->EpCap = reg_val;
#if 1
    p_dqh->OverArea.dTD_NextPtr = USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;
#else // TODO see if Zynq drv really needs that IF
    if (ep_dir == DEF_TRUE) {
        p_dqh->OverArea.dTD_NextPtr = USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;
    }
#endif

//    BSP_DCache_FlushRange(p_dqh, sizeof(USBD_LPCXX_dQH));        /* Write cached memory block back to RAM.               */
    CPU_DCACHE_RANGE_FLUSH(p_dqh, sizeof(USBD_LPCXX_dQH));      /* Write cached memory block back to RAM.               */
                                ...
                                CPU_INT08U   ep_addr)
{
    ...
    (void)USBD_LPCXX_dTD_LstEmpty(p_drv, ep_phy_nbr);
}
...
*               0,                                              otherwise.
*
* Caller(s)   : USBD_EP_ProcessAsyncRxStart() via 'p_drv_api->EP_RxStart()',
*               USBD_EP_Rx() via 'p_drv_api->EP_RxStart()',
*               USBD_EP_RxZLP() via 'p_drv_api->EP_RxStart()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
                                        ...
                                        USBD_ERR    *p_err)
{
    ...
    DEF_BIT_CLR(p_reg->USBINTR, USBD_LPCXX_USB_INT_U);          /* Disable interrupts.                                  */

//    BSP_DCache_InvalidateRange(p_buf, ep_pkt_len);              /* Invalidate (clear) the cached RAM block, so that the */
    CPU_DCACHE_RANGE_INV(p_buf, ep_pkt_len);                    /* Invalidate (clear) the cached RAM block, so that the */
                                                                /* next CPU read will be from RAM again.                */

    USBD_LPCXX_dTD_LstInsert(            p_drv,
                                         ep_phy_nbr,
                                         p_buf,
                             (CPU_INT16U)ep_pkt_len,
                                         p_err);

    DEF_BIT_SET(p_reg->USBINTR, USBD_LPCXX_USB_INT_U);          /* Enable interrupts.                                   */
                                   ...
                                   USBD_ERR    *p_err)
{
    ...
    p_drv_data = (USBD_DRV_DATA  *)(p_drv->DataPtr);
    p_dqh      = &p_drv_data->dQH_Tbl[ep_phy_nbr];
    ep_buf_len =  DEF_MIN(buf_len, USBD_LPCXX_dTD_TOKEN_TOTAL_BYTE_MAX);

    DEF_BIT_CLR(p_reg->USBINTR, USBD_LPCXX_USB_INT_U);          /* Disable interrupts.                                  */

//    BSP_DCache_InvalidateRange(p_buf, buf_len);                 /* Invalidate (clear) the cached RAM block, so that the */
    CPU_DCACHE_RANGE_INV(p_buf, buf_len);                       /* Invalidate (clear) the cached RAM block, so that the */
                                                                /* next CPU read will be from RAM again.                */
//    BSP_DCache_InvalidateRange(p_dqh, sizeof(USBD_LPCXX_dQH));
    CPU_DCACHE_RANGE_INV(p_dqh, sizeof(USBD_LPCXX_dQH));

                                                                /* Chk for err.                                         */
    ep_token = p_dqh->dTD_LstHeadPtr->Token;

    if (DEF_BIT_IS_SET_ANY(ep_token, USBD_LPCXX_dTD_TOKEN_STATUS_ANY) == DEF_YES) {
        if (DEF_BIT_IS_SET(ep_token, USBD_LPCXX_dTD_TOKEN_STATUS_DATA_ERR) == DEF_YES) {
           *p_err = USBD_ERR_DRV_BUF_OVERFLOW;                  /* Buf ovrf err can happen on any type of EP.           */
        } else if (DEF_BIT_IS_SET(ep_token, USBD_LPCXX_dTD_TOKEN_STATUS_TRAN_ERR) == DEF_YES) {
    ...
    xfer_len_rxd = (CPU_INT16U)(p_dqh->dTD_LstHeadPtr->BufLen -
                              ((p_dqh->dTD_LstHeadPtr->Token  & USBD_LPCXX_dTD_TOKEN_TOTAL_BYTES_MASK) >> 16u));
    ...
    if (xfer_len_rxd != 0u) {
        ...
        if (xfer_len_rxd > ep_buf_len) {
            ...
            p_dqh->dTD_LstHeadPtr->Token = ((p_dqh->dTD_LstHeadPtr->Token) & USBD_LPCXX_dTD_TOKEN_TOTAL_BYTES_MASK)
                                         + ((xfer_len_rxd << 16u)          & USBD_LPCXX_dTD_TOKEN_TOTAL_BYTES_MASK);
...
//            BSP_DCache_FlushRange(p_dqh, sizeof(USBD_LPCXX_dQH));
    ...
    USBD_LPCXX_dTD_LstRemove(p_drv, ep_phy_nbr);
...
//    BSP_DCache_FlushRange(p_buf, buf_len);                      /* Write the cached memory block back to RAM, before    */
    CPU_DCACHE_RANGE_FLUSH(p_buf, buf_len);                     /* Write the cached memory block back to RAM, before... */
...
//    BSP_DCache_InvalidateRange(&(p_drv_data->dQH_Tbl[ep_phy_nbr].dTD_LstNbrEntries), sizeof(CPU_REG32));
    CPU_DCACHE_RANGE_INV(&(p_drv_data->dQH_Tbl[ep_phy_nbr].dTD_LstNbrEntries), sizeof(CPU_REG32));

    entries = p_drv_data->dQH_Tbl[ep_phy_nbr].dTD_LstNbrEntries;

    if (USBD_EP_IS_IN(ep_addr) == DEF_YES) {
        ep_flush = USBD_LPCXX_ENDPTxxx_GET_TX_BITS(ep_log_nbr);
    } else {
        ep_flush = USBD_LPCXX_ENDPTxxx_GET_RX_BITS(ep_log_nbr);
    }

    nbr_retries = USBD_LPCXX_MAX_RETRIES;
    ...
    for (ix = 0u; ix < entries; ix++) {
        ok = USBD_LPCXX_dTD_LstRemove(p_drv, ep_phy_nbr);
        if (ok == DEF_FAIL) {
            break;
        }
    }
    ...
    if (state == DEF_SET) {
        ...
        if (ep_log_nbr > 0u) {
            if (USBD_EP_IS_IN(ep_addr) == DEF_YES) {
                ...
                DEF_BIT_SET(p_reg->ENDPTCTRLx[ep_log_nbr],
                            USBD_LPCXX_ENDPTCTRL_TX_TOGGLE_RST);
            } else {
                DEF_BIT_CLR(p_reg->ENDPTCTRLx[ep_log_nbr],
                            USBD_LPCXX_ENDPTCTRL_RX_STALL);

                DEF_BIT_SET(p_reg->ENDPTCTRLx[ep_log_nbr],
                            USBD_LPCXX_ENDPTCTRL_RX_TOGGLE_RST);
            }
        }
    }
...
static  void  USBD_DrvISR_Handler (USBD_DRV  *p_drv)
{
    USBD_LPCXX_REG      *p_reg;
    USBD_DRV_DATA       *p_drv_data;
    USBD_LPCXX_dTD_EXT  *p_dtd;
    USBD_LPCXX_dTD_EXT  *p_dtd_next;
    ...
    if (int_status != DEF_BIT_NONE) {
        ...
        if (DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_U) == DEF_YES) {
            p_reg->USBSTS = USBD_LPCXX_USB_INT_U;
            ...
            while (ep_complete != DEF_BIT_NONE) {
                ...
                if (DEF_BIT_IS_SET_ANY(ep_complete, USBD_LPCXX_ENDPTCOMPLETE_TX_MASK) == DEF_YES) {
                    ep_log_nbr = (CPU_INT08U)(31u - CPU_CntLeadZeros32(USBD_LPCXX_ENDPTxxx_GET_TX_NBR(ep_complete)));
                    ep_phy_nbr =  USBD_EP_ADDR_TO_PHY(USBD_EP_LOG_TO_ADDR_IN(ep_log_nbr));

                    ep_complete &= ~USBD_LPCXX_ENDPTxxx_GET_TX_BITS(ep_log_nbr);
                    p_dtd        =  p_drv_data->dQH_Tbl[ep_phy_nbr].dTD_LstHeadPtr;

//                    BSP_DCache_InvalidateRange(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));
                    CPU_DCACHE_RANGE_INV(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));
                                                                /* Loop if many dTDs have completed in a single int.    */
                    while (DEF_BIT_IS_CLR(p_dtd->Token, USBD_LPCXX_dTD_TOKEN_STATUS_ACTIVE) == DEF_YES) {
                        p_dtd_next = (USBD_LPCXX_dTD_EXT *)p_dtd->dTD_NextPtr;

                        USBD_EP_TxCmpl(p_drv, ep_log_nbr);
                        USBD_LPCXX_dTD_LstRemove(p_drv, ep_phy_nbr);

                        if (DEF_BIT_IS_SET((CPU_REG32)p_dtd_next, USBD_LPCXX_dTD_dTD_NEXT_TERMINATE) == DEF_YES) {
                            break;
                        }
                        p_dtd = p_dtd_next;
//                        BSP_DCache_InvalidateRange(p_dtd, sizeof(USBD_LPCXX_dTD_EXT)); // !!!! not in original Zynq drv. Added by me
                        CPU_DCACHE_RANGE_INV(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));
                    }
                }

                if (DEF_BIT_IS_SET_ANY(ep_complete, USBD_LPCXX_ENDPTCOMPLETE_RX_MASK) == DEF_YES) {
                    ep_log_nbr = (CPU_INT08U)(31u - CPU_CntLeadZeros32(USBD_LPCXX_ENDPTxxx_GET_RX_NBR(ep_complete)));
                    ep_phy_nbr =  USBD_EP_ADDR_TO_PHY(USBD_EP_LOG_TO_ADDR_OUT(ep_log_nbr));

                    ep_complete &= ~USBD_LPCXX_ENDPTxxx_GET_RX_BITS(ep_log_nbr);
                    p_dtd        =  p_drv_data->dQH_Tbl[ep_phy_nbr].dTD_LstHeadPtr;
...
//                    BSP_DCache_InvalidateRange(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));
                    ...
                    while (DEF_BIT_IS_CLR(p_dtd->Token, USBD_LPCXX_dTD_TOKEN_STATUS_ACTIVE) == DEF_YES) {
                        ...
                        if (DEF_BIT_IS_CLR(p_dtd->Attrib, USBD_LPCXX_dTD_EXT_ATTRIB_IS_COMPLETED) == DEF_YES) {
                            USBD_EP_RxCmpl(p_drv, ep_log_nbr);
                            DEF_BIT_SET(p_dtd->Attrib, USBD_LPCXX_dTD_EXT_ATTRIB_IS_COMPLETED);
                            CPU_DCACHE_RANGE_FLUSH((void *)p_dtd->Attrib,
                                                           sizeof(CPU_REG32));   // !!!! added by me
                        }
                                                                /* End of dTD list attached to this dQH.                */
                        if ((((CPU_REG32)p_dtd_next)                                                  == ((CPU_REG32) 1)) ||
                            (DEF_BIT_IS_SET((CPU_REG32)p_dtd_next, USBD_LPCXX_dTD_dTD_NEXT_TERMINATE) == DEF_YES)) {
                            break;
                        }
                        p_dtd = p_dtd_next;
//                        BSP_DCache_InvalidateRange(p_dtd, sizeof(USBD_LPCXX_dTD_EXT)); // !!!! not in original Zynq drv. Added by me
        ...
        if (DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_UE) == DEF_YES) {
            p_reg->USBSTS = USBD_LPCXX_USB_INT_UE;
        }

                                                                /* ------------- LOW-FREQUENCY INTERRUPTS ------------- */
                                                                /* (3) Process the bus change interrupts                */
                                                                /* ---------------- USB RESET INTERRUPT --------------- */
        if (DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_UR) == DEF_YES) {

            USBD_LPCXX_SoftRst(p_drv);                          /* Perform a soft reset                                 */

            USBD_EventReset(p_drv);                             /* Notify bus reset.                                    */

            p_reg->USBSTS  = USBD_LPCXX_USB_INT_UR;             /* Clear the interrupt                                  */
            p_reg->USBINTR = USBD_LPCXX_USB_INT_SL
                           | USBD_LPCXX_USB_INT_UR
                           | USBD_LPCXX_USB_INT_PC
                           | USBD_LPCXX_USB_INT_U
                           | USBD_LPCXX_USB_INT_UE;
        }

                                                                /* --------------- USB SUSPEND INTERRUPT -------------- */
                                                                /* See Note #1.                                         */
        if ((DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_SL) == DEF_YES) &&
            (p_drv_data->Suspend                               == DEF_FALSE)) {

            USBD_EventSuspend(p_drv);

            p_reg->USBSTS  = USBD_LPCXX_USB_INT_SL;             /* Clear the suspend interrupt                          */
            p_reg->USBINTR = USBD_LPCXX_USB_INT_UR              /* Enable the Reset and Port change interrupt           */
                           | USBD_LPCXX_USB_INT_U
                           | USBD_LPCXX_USB_INT_PC
                           | USBD_LPCXX_USB_INT_UE;
            p_drv_data->Suspend = DEF_TRUE;

        } else if ((DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_SL) == DEF_NO) &&
                   (p_drv_data->Suspend                               == DEF_TRUE)) {
        ...
        if (DEF_BIT_IS_SET(int_status, USBD_LPCXX_USB_INT_PC) == DEF_YES) {
                                                                /* Detect the speed of the device                       */
            if (DEF_BIT_IS_SET(p_reg->PORTSC1, USBD_LPCXX_PORTSC1_HSP) == DEF_YES) {
                USBD_EventHS(p_drv);                            /* Notify high-speed event.                             */
            }
                                                                /* Clear the Port change interrupt                       */
            p_reg->USBSTS = USBD_LPCXX_USB_INT_PC;
        }
    }
}
                               ...
                               USBD_ERR    *p_err)
{
    ...
    Mem_PoolCreate(             &p_drv_data->dTD_MemPool,       /* Create EP device transfer descriptor memory pool.    */
                   (void       *)0,                             /* From heap.                                           */
                                 0u,
                                 USBD_LPCXX_dTD_NBR,            /* Take into account extra URBs if used.                */
                                (sizeof(USBD_LPCXX_dTD_EXT)),
                                 USBD_LPCXX_ALIGN_OCTECTS_dTD,
                   (CPU_SIZE_T *)0,
                                &err_lib);
    ...
    p_drv_data->dQH_Tbl = (USBD_LPCXX_dQH *)Mem_HeapAlloc(              (sizeof(USBD_LPCXX_dQH) * ep_phy_nbr_max),
                                                                         USBD_LPCXX_ALIGN_OCTECTS_dQH,
                                                          (CPU_SIZE_T  *)0,
                                                                        &err_lib);
    if (err_lib != LIB_MEM_ERR_NONE) {
       *p_err = USBD_ERR_ALLOC;
    ...
    Mem_Clr((void  *) p_drv_data->dQH_Tbl,
                     (sizeof(USBD_LPCXX_dQH) * (ep_phy_nbr_max)));
                                        ...
                                        USBD_ERR    *p_err)
{
    ...
    if (((p_reg->ENDPTCTRLx[ep_log_nbr] & USBD_LPCXX_ENDPTCTRL_TX_TYPE_MASK) != USBD_LPCXX_ENDPTCTRL_TX_TYPE_CTRL) ||
        ((p_reg->ENDPTCTRLx[ep_log_nbr] & USBD_LPCXX_ENDPTCTRL_RX_TYPE_MASK) != USBD_LPCXX_ENDPTCTRL_RX_TYPE_CTRL)) {
        ...
        dTD_avail = USBD_LPCXX_dTD_NBR - dtd_used;
                                                                /* See Note #2.                                         */
        if ((((CPU_INT16U)(dtd_used + ep_empty))    < (USBD_LPCXX_dTD_NBR - 1u)) ||
...
#endif
                                                                /* (1) Get a dTD from the memory pool                   */
    p_dtd = (USBD_LPCXX_dTD_EXT *)Mem_PoolBlkGet(&p_drv_data->dTD_MemPool,
                                                  sizeof(USBD_LPCXX_dTD_EXT),
                                                 &err_lib);
    if (err_lib != LIB_MEM_ERR_NONE) {
       *p_err = USBD_ERR_FAIL;
    ...
    Mem_Clr((void *)p_dtd,                                      /* ... Initialize the dTD to 0x00                       */
                    sizeof(USBD_LPCXX_dTD_EXT));
                                                                ...
                                                                /* (2) Build the transfer descriptor                    */
    p_dtd->dTD_NextPtr = USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;     /* ... Set the terminate bit to 1                       */
                                                                /* ... Fill in the total transfer len.                  */
    p_dtd->Token       = ((len << 16u) & USBD_LPCXX_dTD_TOKEN_TOTAL_BYTES_MASK)
                                       | USBD_LPCXX_dTD_TOKEN_IOC
                                       | USBD_LPCXX_dTD_TOKEN_STATUS_ACTIVE;
...
//    BSP_DCache_FlushRange(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));   /* Write cached memory block back to RAM.               */
    CPU_DCACHE_RANGE_FLUSH(p_dtd, sizeof(USBD_LPCXX_dTD_EXT));  /* Write cached memory block back to RAM.               */
...
//    BSP_DCache_InvalidateRange(p_dqh, sizeof(USBD_LPCXX_dQH));  /* Invalidate (clear) the cached RAM block, so that the */
    ...
    if (p_dqh->dTD_LstNbrEntries == 0u) {                       /* ... Case 1: Link list is empty                       */
        ...
        DEF_BIT_CLR(p_dqh->OverArea.Token, USBD_LPCXX_dTD_TOKEN_STATUS_MASK);

//        BSP_DCache_FlushRange(p_dqh, sizeof(USBD_LPCXX_dQH));   /* Write cached memory block back to RAM.               */
        CPU_DCACHE_RANGE_FLUSH(p_dqh, sizeof(USBD_LPCXX_dQH));  /* Write cached memory block back to RAM.               */

                                                                /* (c) Prime the endpoint                               */
        if (USBD_LPCXX_EP_PHY_NBR_IS_OUT(ep_phy_nbr) == DEF_YES) {
            p_reg->ENDPTPRIME = USBD_LPCXX_ENDPTxxx_GET_RX_BITS(ep_log_nbr);
        } else {
            p_reg->ENDPTPRIME = USBD_LPCXX_ENDPTxxx_GET_TX_BITS(ep_log_nbr);
        }
    } else {                                                    /* ... Case 2: Link list is not empty                   */
...
//        BSP_DCache_FlushRange(p_dqh, sizeof(USBD_LPCXX_dQH));    /* Write cached memory block back to RAM.               */
        ...
        if (USBD_LPCXX_EP_PHY_NBR_IS_OUT(ep_phy_nbr) == DEF_YES) {
            valid_bit = DEF_BIT_IS_SET(USBD_LPCXX_ENDPTxxx_GET_RX_NBR(p_reg->ENDPTPRIME),
                                      (DEF_BIT32(ep_log_nbr)));
        } else {
            valid_bit = DEF_BIT_IS_SET(USBD_LPCXX_ENDPTxxx_GET_TX_NBR(p_reg->ENDPTPRIME),
                                      (DEF_BIT32(ep_log_nbr)));
        }
        ...
        insert_nbr_tries = USBD_LPCXX_dTD_LST_INSERT_NBR_TRIES_MAX;
        ...
        while ((insert_complete  == DEF_FALSE) &&
               (insert_nbr_tries >  0u)) {
                                                                ...
                                                                /* (c) Set ATDTW (HW sem) bit in USBCMD register to '1' */
            DEF_BIT_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_ATDTW);

            ep_status = p_reg->ENDPTSTATUS;                     /* (d) Read correct status bits in ENDPSTATUS           */

                                                                /* (e) Read ATDTW bit in USBCMD register ...            */
            if (DEF_BIT_IS_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_ATDTW) == DEF_YES){
        ...
        if (insert_complete == DEF_FALSE) {
            ...
            p_dqh->dTD_LstTailPtr->dTD_NextPtr = USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;
            p_dqh->dTD_LstNbrEntries--;
...
//            BSP_DCache_FlushRange(p_dqh, sizeof(USBD_LPCXX_dQH));
        ...
        DEF_BIT_CLR(p_reg->USBCMD, USBD_LPCXX_USBCMD_ATDTW);    /* (f) Set ATDTW (HW sem) bit in USBCMD register to '0' */

        if (USBD_LPCXX_EP_PHY_NBR_IS_OUT(ep_phy_nbr) == DEF_YES) {
            valid_bit = DEF_BIT_IS_SET(USBD_LPCXX_ENDPTxxx_GET_RX_NBR(ep_status),
                                      (DEF_BIT32(ep_log_nbr)));
        } else {
            valid_bit = DEF_BIT_IS_SET(USBD_LPCXX_ENDPTxxx_GET_TX_NBR(ep_status),
                                      (DEF_BIT32(ep_log_nbr)));
        }
        ...
        if (valid_bit == DEF_YES) {
           ...
           *p_err = USBD_ERR_NONE;
            ...
            DEF_BIT_CLR(p_dqh->OverArea.Token,
                        USBD_LPCXX_dTD_TOKEN_STATUS_MASK);

            CPU_DCACHE_RANGE_FLUSH(p_dqh, sizeof(USBD_LPCXX_dQH));  // !!!! added by me
...
*                              0             1               N
*
*               after the USBD_LPCXX_dTD_LstRemove() is called the link list will look like:
*
*                      |--------------------|
*                      | |            |     V
*                      | |  +-----+   |  +-----+          +-----+
                                               ...
                                               CPU_INT08U   ep_phy_nbr)
{
    USBD_DRV_DATA       *p_drv_data;
    USBD_LPCXX_dQH      *p_dqh;
    USBD_LPCXX_dTD_EXT  *p_dtdlst_head;
    LIB_ERR              err_lib;
    CPU_SR_ALLOC();
...
//                                                                /* next CPU read will be from RAM again.                */
    if (p_dqh->dTD_LstNbrEntries == 1u) {
        p_dqh->dTD_LstHeadPtr    = (USBD_LPCXX_dTD_EXT *)USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;
        p_dqh->dTD_LstTailPtr    = (USBD_LPCXX_dTD_EXT *)USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;
        p_dqh->dTD_LstNbrEntries = 0u;
    } else {
        p_dqh->dTD_LstHeadPtr = (USBD_LPCXX_dTD_EXT *)p_dqh->dTD_LstHeadPtr->dTD_NextPtr;
        p_dqh->dTD_LstNbrEntries--;
    }
#if (USBD_CFG_MAX_NBR_URB_EXTRA > 0u)
    (p_drv_data->dTD_UsageTbl[ep_phy_nbr])--;
...
//    BSP_DCache_InvalidateRange(p_dqh, sizeof(USBD_LPCXX_dQH));  /* Invalidate (clear) the cached RAM block, so that the */ // !!!! this invalidate cache is not nec
//                                                                /* next CPU read will be from RAM again.                */

    if (p_drv_data->Ctrlr == USBD_NXP_USBX_CTRLR_LPCXX) {       /* See Note #1.                                         */
    ...
    while ((sutw_set == DEF_FALSE) &&
        ...
        DEF_BIT_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_SUTW);     /* (2) Write '1' to setup Tripwire                      */
...
//        BSP_DCache_InvalidateRange(p_dqh, sizeof(USBD_LPCXX_dQH));
        ...
        sutw_set = DEF_BIT_IS_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_SUTW);
        reg_to--;
    }
    if (reg_to == 0u) {
        return;
    ...
    DEF_BIT_CLR(p_reg->USBCMD, USBD_LPCXX_USBCMD_SUTW);         /* (5) Write '0' to clear setup Tripwire                */
...
#if 0 // TODO (Zynq) to verify if Zynq really needs it
...
static  void  USBD_LPCXX_SoftRst (USBD_DRV  *p_drv)
{
    ...
    if (ep_phy_nbr_max != USBD_EP_PHY_NONE) {
        for (ep_phy_nbr = 0u; ep_phy_nbr < ep_phy_nbr_max; ep_phy_nbr++) {
            ...
            USBD_LPCXX_dTD_LstEmpty(p_drv, ep_phy_nbr);

            p_drv_data->dQH_Tbl[ep_phy_nbr].EpCap                = 0u;
            p_drv_data->dQH_Tbl[ep_phy_nbr].OverArea.dTD_NextPtr = USBD_LPCXX_dTD_dTD_NEXT_TERMINATE;

            Mem_Clr((void *)&p_drv_data->dQH_Tbl[ep_phy_nbr].OverArea.Token,
                           (sizeof(USBD_LPCXX_dQH) - 2u));

//            BSP_DCache_FlushRange(&(p_drv_data->dQH_Tbl[ep_phy_nbr]), sizeof(USBD_LPCXX_dQH));
            CPU_DCACHE_RANGE_FLUSH(&(p_drv_data->dQH_Tbl[ep_phy_nbr]), sizeof(USBD_LPCXX_dQH));

            ep_log_nbr = USBD_EP_PHY_TO_LOG(ep_phy_nbr);
            if ((ep_log_nbr != 0u) &&
                (DEF_BIT_IS_SET(p_reg->USBCMD, USBD_LPCXX_USBCMD_RUN) == DEF_YES)) {
                p_reg->ENDPTCTRLx[ep_log_nbr] = USBD_LPCXX_ENDPTCTRL_TX_TOGGLE_RST |
                                                USBD_LPCXX_ENDPTCTRL_RX_TOGGLE_RST;
            }
        }
    }
    ...
    p_reg->ENDPTFLUSH = USBD_LPCXX_ENDPTxxxx_TX_MASK |
                        USBD_LPCXX_ENDPTxxxx_RX_MASK;
    ...
    if (DEF_BIT_IS_SET(p_reg->USBCMD,  USBD_LPCXX_USBCMD_RUN) == DEF_YES) {
