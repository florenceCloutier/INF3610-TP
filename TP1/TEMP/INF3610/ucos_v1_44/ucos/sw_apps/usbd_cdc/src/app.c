...
*                                          SETUP INSTRUCTIONS
*
*   This demonstration project illustrates a basic uC/USB-Device project showcasing the CDC class.
...
*
*   4. Host driver configuration
*       On Windows a CDC driver needs to be installed. They can be found in the USBD-Host package at
...
void APP_USBD_Init (void)
{
    ...
    App_USBD_CDC_Init(dev_nbr, cfg_hs_nbr, cfg_fs_nbr);
