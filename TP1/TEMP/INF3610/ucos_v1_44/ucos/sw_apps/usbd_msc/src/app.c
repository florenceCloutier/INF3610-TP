...
*                                          SETUP INSTRUCTIONS
*
*   This demonstration project illustrates a basic uC/USB-Device project showcasing the MSC class.
...
*
*   3. File system volume configuration
*       To configure and SD Card from the ucos BSP configuration dialog expand the SD Card category. From there,
...
void APP_USBD_Init (void)
{
    ...
    App_USBD_MSC_Init(dev_nbr, cfg_hs_nbr, cfg_fs_nbr);
