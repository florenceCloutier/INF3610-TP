...
#define  DNSc_VERSION               20100u                      /* See Note #1.                                         */
...
#define  DNSc_REVERSE_MAPPING_DOMAIN_STR     ".in-addr.arpa"
#define  DNSc_REVERSE_MAPPING_DOMAIN_STR_LEN   13u
...
typedef  enum DNSc_state {
    ...
    DNSc_STATE_TX_REQ_PTR,
    DNSc_STATE_RX_RESP_PTR,
    DNSc_STATE_RESOLVED,
    DNSc_STATE_FAILED,
} DNSc_STATE;
...
DNSc_STATUS  DNSc_GetHost         (const  CPU_CHAR       *p_host_name,
                                          CPU_CHAR       *p_rev_host_name,
                                          CPU_INT32U      rev_hostname_len,
